...
namespace RESTFUL.DataSet1TableAdapters {
    ...
    public partial class productosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM \"public\".\"productos\" WHERE ((\"ean\" = :Original_ean))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"public\".\"productos\" (\"ean\", \"idproveedor\", \"nombre\", \"imagen\", \"desc" +
                "ripcion\", \"estado\") VALUES (:ean, :idproveedor, :nombre, :imagen, :descripcion, " +
                ":estado)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE \"public\".\"productos\" SET \"ean\" = :ean, \"idproveedor\" = :idproveedor, \"nomb" +
                "re\" = :nombre, \"imagen\" = :imagen, \"descripcion\" = :descripcion, \"estado\" = :est" +
                "ado WHERE ((\"ean\" = :Original_ean))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["GasStationPharmacyConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ean, idproveedor, nombre, imagen, descripcion, estado FROM \"public\".produc" +
                "tos";
        ...
        public virtual int Delete(int Original_ean) {
        ...
        public virtual int Insert(int ean, int idproveedor, string nombre, string imagen, string descripcion, int estado) {
        ...
        public virtual int Update(int ean, int idproveedor, string nombre, string imagen, string descripcion, int estado, int Original_ean) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int idproveedor, string nombre, string imagen, string descripcion, int estado, int Original_ean) {
            return this.Update(Original_ean, idproveedor, nombre, imagen, descripcion, estado, Original_ean);
        }
    }
        ...
        public virtual int UpdateAll(DataSet1 dataSet) {
            ...
            try {
                ...
                if ((this._productosTableAdapter != null)) {
                    ...
                    this._productosTableAdapter.Connection = ((global::Devart.Data.PostgreSql.PgSqlConnection)(workConnection));
                    this._productosTableAdapter.Transaction = ((global::System.Data.Common.DbTransaction)(workTransaction));
                ...
                if ((this._productosTableAdapter != null)) {
                    this._productosTableAdapter.Connection = ((global::Devart.Data.PostgreSql.PgSqlConnection)(revertConnections[this._productosTableAdapter]));
